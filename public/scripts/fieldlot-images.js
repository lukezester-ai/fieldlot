...
(function initFieldlotImages(global) {
	...
	global.FieldlotImages = {
		...
		/** Профил „Профил на фермер с доверие“ */
		...
		farmers: [
			{
				...
				role: 'Зърно · Добруджа',
				rating: '4.9',
				img: u('photo-1500659848292-51869a7d3f2c', 200),
			},
			{
				name: 'Мария К.',
				role: 'Зеленчуци · Юг',
				rating: '4.8',
				img: u('photo-1573496359142-b8d87734a5a2', 200),
			},
			{
				name: 'Георги Д.',
				role: 'Овощевъд · Пловдив',
				rating: '4.7',
				img: u('photo-1595273670154-84ffe2938165', 200),
			},
			{
				name: 'Петър С.',
				role: 'Маслодайни · Север',
				rating: '4.9',
				img: u('photo-1507003211169-0a1dd7228f2d', 200),
			},
		],
		logistics: {
